define(function(require){
  ...
  // icons.draw('lt_lumen')  etc
  return {draw:{
    // lt_lumen, ec_raw, sm_raw, lq_norm, st_celsius, vd_voltage, at_celsius, syn_sm_vwc, syn_ec_dsm
  	lt_lumen  : function(cnvs){ icons.sun(cnvs[0],true);          return cnvs; },
    st_celsius: function(cnvs){ icons.thermometer(cnvs[0],true);  return cnvs; },
    at_celsius: function(cnvs){ icons.thermometer(cnvs[0],false); return cnvs; },
    sm_raw    : function(cnvs){ icons.drop(cnvs[0],true);         return cnvs; },
    ec_raw    : function(cnvs){ icons.elec(cnvs[0],true);         return cnvs; }
  }};
});